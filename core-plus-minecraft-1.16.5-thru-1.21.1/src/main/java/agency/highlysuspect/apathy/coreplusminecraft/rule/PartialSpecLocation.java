...
public class PartialSpecLocation implements Spec<Partial, PartialSpecLocation> {
	...
	public Spec<Partial, ?> optimize() {
		if(ApathyPlusMinecraft.instanceMinecraft.isLocationPredicateAny(pred)) return PartialSpecAlways.TRUE;
		else return this;
	}
	...
	public static class Serializer implements JsonSerializer<PartialSpecLocation> {
		...
		public void write(PartialSpecLocation thing, JsonObject json) {
			json.add("predicate", ApathyPlusMinecraft.instanceMinecraft.serializeLocationPredicate(thing.pred));
		...
		public PartialSpecLocation read(JsonObject json) {
			LocationPredicate pred = ApathyPlusMinecraft.instanceMinecraft.deserializeLocationPredicate(json.get("predicate"));
