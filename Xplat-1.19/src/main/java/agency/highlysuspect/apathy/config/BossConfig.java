...
public class BossConfig extends Config {
	...
	@Use("difficultySet")
	public Set<Difficulty> witherDifficulties = Apathy119.allDifficultiesNotPeaceful();
	...
	@Use("difficultySet")
	public Set<Difficulty> wardenDarknessDifficulties = Apathy119.allDifficultiesNotPeaceful();
